...
body {
	...
	<?php if( isset($pageID) ) { ?>background: url(../content/image/header1.jpg) no-repeat top left;<? } else { ?>background: url(../content/image/header2.jpg) no-repeat top left;<? } ?>
...
.about_header {
	...
	background: url(../content/image/about_title.png) no-repeat top left;
    margin-top: 20px;
	height: 24px;
    width: 188px;
    border-collapse: collapse;
