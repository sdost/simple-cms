<xsl:transform version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:template match="/">
        <html>
            ...
            <body>
                ...
                <link rel="stylesheet" type="text/css" href="css/general.css.php" />
                <div id="header" />
                <div id="main_body">
                    <div class="menu">
    ...
    <xsl:template match="page_layout/breadcrumb">
    	<xsl:for-each select="crumb_item">
	        <a href="http://www.google.com">Home</a> > <xsl:value-of select="@name"/>
        </xsl:for-each>                
    </xsl:template>
    ...
    <xsl:template match="about">
    	<div class="about_header"><img alt="header" src="content/image/about_titles.png"/></div>
